...
import Group from '../../public/Group 102.png'
interface Product {
  id: number;
  title: string;
  price: number;
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="p-3 sm:p-4 border-t border-gray-100">
                  ...
                  {/* Availability & Rating */}
                  <p className="text-xs text-gray-500 mb-2">5 types available</p>
                  {product.rating && (
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 bg-purple-800 hover:bg-purple-900 text-white px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg font-semibold text-xs sm:text-sm transition-all">
                      Add to Cart
                    </button>
